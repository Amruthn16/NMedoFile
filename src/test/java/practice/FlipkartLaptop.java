...
public class FlipkartLaptop {
	public static void main(String[] args) throws InterruptedException {
		...
		List<WebElement> name = driver.findElements(By.xpath("//div[@class='_30jeq3 _1_WHN1'][not(number(translate(text(),'₹,',' '))>30000 and number(translate(text(),'₹,',' '))<50000)]/ancestor::div[@class='_3pLy-c row']/child::div/child::div[@class='_4rR01T']"));
